...
## Purpose
n8n is a workflow automation platform that enables users to build, run, and manage automated workflows connecting various services and APIs. This deployment runs n8n in host network mode with a named volume for data persistence.
...
### External
- `n8nio/n8n` — workflow automation and integration platform
